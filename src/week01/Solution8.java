package week01; /** 문제 https://www.acmicpc.net/problem/10162
 *  문제
 ...
 * 우리는 A, B, C 3개의 버튼을 적절히 눌러서 그 시간의 합이 정확히 T초가 되도록 해야 한다. 단 버튼 A, B, C를 누른 횟수의 합은 항상 최소가 되어야 한다.
 * 이것을 최소버튼 조작이라고 한다.
 *
 * 만일 요리시간이 100초라고 하면(T=100) B를 1번, C는 4번 누르면 된다.
 * 이와 다르게 C를 10번 눌러도 100초가 되지만 이 경우 10번은 최소 횟수가 아니기 때문이 답이 될 수 없다. 이 경우 B 1번, C 4번, 총 5번이 최소버튼 조작이다.
...
public class Solution8 {
    public static void main(String[] args) {
        ...
        int second = sc.nextInt(); // 전자레인지 돌리는 초
        int cntFive = 0;
        int cntOne = 0;
        int cntTenSecond = 0;
